...
WebUI.setText(findTestObject('User Login/input_Your emailusername_username'), GlobalVariable.merchant_no_req_username)

WebUI.setText(findTestObject('User Login/input_Your password_password'), GlobalVariable.merchant_no_req_pw)
