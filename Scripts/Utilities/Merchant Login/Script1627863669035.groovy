...
WebUI.setText(findTestObject('User Login/input_Your emailusername_username'), GlobalVariable.submerchant_username)

WebUI.setText(findTestObject('User Login/input_Your password_password'), GlobalVariable.merchant_password)
